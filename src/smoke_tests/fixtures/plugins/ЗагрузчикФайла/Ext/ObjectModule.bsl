...
Функция ЗагрузитьФайл(ПостроительДереваТестов, ФайлОбработки, КонтекстЯдра, ИмяОбработки = "", Настройки = Неопределено) Экспорт // add_plus
	...
	Попытка
		// add_plus
		Контейнер = ЗагрузитьТестыВНовомФормате(ПостроительДереваТестов, Обработка, ФайлОбработки, ИмяОбработки, КонтекстЯдра, Настройки);
		// add_plus
	Исключение
...
Функция ЗагрузитьТестыВНовомФормате(ПостроительДереваТестов, Обработка, ФайлОбработки, ИмяОбработки, КонтекстЯдра, Настройки) // add_plus
	...
	Попытка
		// add_plus
		Обработка.ЗаполнитьНаборТестов(ЭтотОбъект, КонтекстЯдра, Настройки);
		// add_plus
	Исключение
